...
export default function Project() {
  return (
    <div>
      <div className=" overflow-hidden h-auto md:h-[829px] w-[100%] px-[50px] block md:flex text-black ">
        <section className="w-auto h-auto md:w-[50%] md:h-[829px] content-center ">
      ...
      {/* 2 */}
      <div className="w-auto h-auto md:h-[829px] md:w-[100%]  px-[50px] block md:flex text-black ">
        <section className="w-auto h-auto md:w-[50%] md:h-[829px] content-center pt-10 ">
          <Image src="/work.png" alt="arrow" width="510" height="661" />
        </section>

        <section className="w-auto h-auto md:w-[50%] md:h-[829px] flex justify-center md:justify-end text-center md:text-start  items-center p-5 md:p-0 ">
          <div className="flex flex-col md:block">
            ...
            <button className="text-[18px] bg-[#4F9CF9] py-2 px-5 rounded flex items-center gap-3 text-white justify-center">
              Try it now
              <Image src="/arrow.png" alt="arrow" width="10" height="10" />
            </button>
          </div>
