    ...
    <div>
      <div className="overflow-hidden h-auto md:h-full w-[100%] px-[50px] block lg:flex text-black justify-between my-10">
        <section className=" w-auto h-auto md:w-[50%] lg:h-[629px] content-center lg:w-[450px] ">
          ...
          <p className="w-auto md:w-[400px]  text-[16px] md:text-[17px] py-10 text-justify ">
      ...
      {/* 2 */}
      <div className="overflow-hidden w-auto h-auto md:h-[629px] md:w-[100%]  px-[50px] block lg:flex text-black justify-between my-11">
        ...
        <section className="w-auto h-auto md:w-[50%] lg:h-[629px] content-center lg:w-[450px]  ">
          <div className="flex flex-col md:block">
            ...
            <p className="w-auto h-auto md:w-[450px] text-[17px] py-10 text-justify ">
